...
- [3. RESTful vs CRUDful](#restful)
- [4. Characteristics and Constraints of RESTful Server](#characteristics)
- [5. Key Points to Remember](#key)
...
- [9. Design Pattern of Uniform Interfaces (aka Endpoints)](#design)
    - [9.1. Overview](#design_overview)
    - [9.2. Basic Design Patterns](#design_basic)
